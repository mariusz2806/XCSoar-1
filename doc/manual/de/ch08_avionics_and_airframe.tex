...
Wenn das VEGA Variometer angeschlossen ist, erscheint gibt es ein zusätzliches Menü für die am VEGA angeschlossenen Schalter und Eingänge. Ohne VEGA ist dieser Menü-Button grau, also nicht verfügbar \menulabel{\bmenut{Konfig}{1/2}\blink\bmenus{Vega}}
...
Einer der im NMEA-Anschluß Menü befindlichen Treiber (''NMEA-Output'') bietet den sog.\  ''Slave-Modus'', welcher verwendet werden kann,  um z.B. zwei Geräte  (\al oder \textsf{PDA})  im Master-Slave Modus miteinander zu verbinden. \menulabel{\bmenut{Konfig}{3/3}\blink\\,bmenus{NMEA Anschluss}}

Im als Master definierten Gerät muß dazu der Treiber des zweiten  Gerätes (Gerät B) als NMEA OUT gesetzt werden.
\menulabel{\button{Einstellung}\blink\,\button{NMEA Anschluss}}
